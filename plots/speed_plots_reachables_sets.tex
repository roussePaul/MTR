...
%    \pgfsetdash{{1pt}{1pt}}{0pt}% dashing cannot work correctly in all situation this way
    ...
    \newcommand{\tsup}{40.8}
	    ...
	    \newcommand{\tmpxsup}{0.1153793}
	    \newcommand{\tmpxinf}{-0.1153793}
		...
		\addplot[blue,pattern=custom north west lines,hatchspread=\hs,hatchcolor=blue!\al,hatchshift=1.5pt] fill between[of=A and B];
		
	    \renewcommand{\tmpxsup}{0.275}
	    \renewcommand{\tmpxinf}{0.04424139}
        \addplot+[name path=A,black!\op,solid,thin]  coordinates { (\tinf,\tmpxinf) (\tsup,\tmpxinf)}; 
        \addplot+[name path=B,black!\op,solid,thin]  coordinates { (\tinf,\tmpxsup) (\tsup,\tmpxsup)}; 
