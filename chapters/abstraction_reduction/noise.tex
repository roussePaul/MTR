...
\comment{In fact the set $\W_G$ is just a subset of the admissible noise sequences, however, this remain a good tool to see how the noise is affected. Give the example of the noise sequence $\frac{(-1)^n}{n}$}
