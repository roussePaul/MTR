...
\comment{Description of the environment, property to verify, LTL stuff and so on.}

\comment{Say that I will not talk about the noise as we have already talked about before.}
